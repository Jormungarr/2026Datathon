...
EXPERIMENT_PREFIX = "add_year_quarter"
...
# Year at index 6, quarter at index 7
...
for k in [15, 20, 25]:
    ...
    for fold in folds:
        ...
        # Scale only continuous columns (0-5), leave Year (6) and quarter (7) unscaled
        ...
        # Year (6) and quarter (7) remain unscaled
        gam = GammaGAM(
...
plot_gam_terms_plotly(
    ...
    plot_title=f"GAM Partial Dependence Analysis - Year + Quarter (n_splines={best_k})",
...
plot_gam_combined_dashboard_plotly(
    ...
    titles=all_feature_names,
    plot_title=f"GAM Combined Analysis - Year + Quarter - Train RMSE: {train_rmse:.4f} | Test RMSE: {test_rmse:.4f}",
...
plot_gam_feature_importance_plotly(
    ...
    plot_title=f"GAM Feature Importance Analysis - Year + Quarter (EDOF)",
